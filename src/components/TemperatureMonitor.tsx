        ...
        <div className="list-body">
          {temperatureData.slice(0, 10).map((item: TemperatureDataPoint) => (
            <div key={item.id} className="temperature-item">
              ...
              >
                {item.temperature && !isNaN(item.temperature) ? item.temperature.toFixed(1) : 'N/A'}°C
              </span>
